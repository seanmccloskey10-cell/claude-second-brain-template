...
Most people start on the boat. They open ChatGPT, get a brilliant response, close the tab, and lose it forever. They re-explain their work every time. They make decisions that contradict what they decided last week because last week didn't survive.

The island is a huge upgrade. One project, persistent memory across all its sessions. If you're working on one specific thing — a tutoring practice, a research habit, a single product, a thesis — an island is enough. See [the four rhythms](the-four-rhythms.md) for the simplest island setup (it's just the *hello → work → goodbye* loop).
...
- If you only have one thing you care about → an **island** is enough. You may not need this template yet.
...
- **Island can't:** see across projects. If you discover a principle in one island, it won't show up when you're working in another. Both are isolated by design.
- **Continent can't:** save you from yourself. The vault only knows what you put in it. Claude won't synthesise what you haven't captured.
